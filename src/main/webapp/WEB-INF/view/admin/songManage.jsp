    ...
    <div class="container topbar bg-primary d-none d-lg-block">
        <div class="d-flex justify-content-between">
            <div class="top-info ps-2">
                <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#" class="text-white">Block 4, Thach Hoa, Thach That, Ha Noi</a></small>
                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0 bg-secondary rounded-0">
                            <a href="productmanagement" class="dropdown-item active">Product</a>
                            <a href="accountmanagement" class="dropdown-item">Account</a>
                        </div>
                    </div>
